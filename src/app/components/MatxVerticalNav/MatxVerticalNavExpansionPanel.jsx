...
const MatxVerticalNavExpansionPanel = ({ item, children, mode }) => {
  ...
  return (
    <div>
      <TouchRipple
        className={clsx({
          "flex justify-between h-44 w-full pr-4 has-submenu compactNavItem whitespace-pre overflow-hidden": true,
      ...
      >
        <div className="flex items-center">
          {icon && (
            <Icon className="align-middle w-36 px-4 adminIcon">{icon}</Icon>
          )}
        ...
        <div
          className={clsx({
            "item-arrow sidenavHoverShow pr-4": true,
