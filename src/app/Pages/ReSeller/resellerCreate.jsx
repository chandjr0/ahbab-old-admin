  ...
  const formSubmitHandler = async (data) => {
    ...
    try {
      ...
      let obj = {
        ...
        legalDocs: docImage,
        status: status?'active':'inactive', // "pending", "active"
      ...
      setIsLoading(true);
      const res = await axios.post(`/reseller/add`, obj);
      if (res?.data?.success) {
    ...
    <div className="m-sm-30">
      ...
      <Grid container>
        <Grid item md={12} xs={12}>
          <Card elevation={3}>
            <CardHeader title="Add New Re-seller" />
                ...
                <Grid item sm={6} xs={6}>
                  ...
                  <div style={{display:'flex',flexDirection:'row'}}>
                    ...
                    <Box sx={{ mb: 2 }}>
                      ...
                      <Upload
                        listType="picture-card"
                        onChange={docImageHandler}
                      >
                        {profileFileList.length < 5 && (
                          <span>
                            <span>Upload</span>
                            <br />
                            <span style={{ color: "red", fontSize: "12px" }}>
