...
const OldProducts = ({ customerId, orderId }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      let res = await axios.get(
        `/order/customers/previous-orders/${customerId}/${orderId}?page=${page}&limit=3`
      );
  ...
  return (
    <>
      <Card elevation={3}>
        <CardHeader title="previous order" />
        <CardContent>
          {totalPage > 0 ? 
          <> <div
          style={{
                  ...
                  <TableRow key={idx}>
                    ...
                    <TableCell align="center">
                      ...
                      >
                        <Box>
                          <Avatar
                            src={imageBasePath + "/" + data?.products[0]?.galleryImage[0]}
                            alt={data[0]?.name}
                    ...
                    <TableCell align="center">{data?.customerCharge?.remainingTkPay}</TableCell>
                    <TableCell align="center">
        ...
        </Box></>: <p className="text-gray text-center my-2">No Previous Order Found</p>
