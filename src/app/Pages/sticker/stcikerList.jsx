...
const StickerList = ({ dataList, setDataList, setUpdateData }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setIsLoading(true);
        let res = await axios.get("/sticker/fetch-all");
  ...
  const deleteHandler = async () => {
    try {
      let res = await axios.delete(`/sticker/delete/${deleteId}`);
                  ...
                  <TableBody>
                    {dataList.map((data, index) => (
                      <TableRow key={index}>
                        ...
                        <Tooltip title={"color"} placement="bottom-start">
                          <TableCell className="capitalize" align="center">
                            <Box
                              sx={{
                                display: "flex",
