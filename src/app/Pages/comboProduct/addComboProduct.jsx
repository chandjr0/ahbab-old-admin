...
const PurchaseCreate = () => {
  ...
  const formSubmitHandler = async (event) => {
    ...
    try {
      let res = await axios.post("/combo/admin/create", obj);
      if (res?.data?.success) {
                              ...
                              <TableRow>
                                ...
                                >
                                  <TextField
                                    ...
                                    style={{ minWidth: "80px" }}
                                    size="small"
                                    value={data?.comboPrice}
                                    onChange={(e) =>
                                      priceHandler(e.target.value, data?.id)
                                    }
                                  />
                                </TableCell>
      ...
      <Grid container className="my-6">
        ...
        <Grid item xs={12}>
          <form onSubmit={handleSubmit(formSubmitHandler)}>
            ...
            {/* description */}
            <Card className="elevation-z4 mb-6">
              <CardHeader title="Descriptionss" />
              <CardContent>
                <RichTextEditor
